  ...
  return buildMarketView(
    {
      ...
      lastResolveDecisionAt: record.lastResolveDecisionAt ?? null,
      lastResolveDecision: record.lastResolveDecision ?? "",
      lastResolveDecisionReason: record.lastResolveDecisionReason ?? "",
      lastResolveSourceSummary: record.lastResolveSourceSummary ?? "",
      lastResolveSpreadBps: record.lastResolveSpreadBps ?? null,
      lastResolvedAt: record.lastResolvedAt ?? null,
      lastResolvedFinalPrice: record.lastResolvedFinalPrice ?? "",
      lastResolvedSourceSummary: record.lastResolvedSourceSummary ?? "",
      lastResolvedSpreadBps: record.lastResolvedSpreadBps ?? null,
